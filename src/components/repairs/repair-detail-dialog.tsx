  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] max-w-lg overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="font-mono">Fiche {repair.id.substring(0, 8)}</DialogTitle>
          <DialogDescription>
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            <SelectTrigger className={`h-9 w-full max-w-[220px] ${statusMap[repair.status as RepairStatus]?.color || ''}`}>
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <Tabs defaultValue="info" className="w-full">
          ...
          <TabsContent value="info" className="mt-4 space-y-3">
            ...
            <div className="space-y-2">
              ...
              <Textarea value={issueText} onChange={(e) => setIssueText(e.target.value)} rows={3} className="text-sm" />
            </div>
            <div className="space-y-2">
          ...
          <TabsContent value="parts" className="mt-4 space-y-4">
            <p className="text-xs text-muted-foreground">
              Les sorties sont tracées dans l’inventaire (
            ...
            <form onSubmit={submitPart} className="space-y-3 rounded-lg border bg-muted/20 p-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input type="number" min={0} value={partUnit || ''} onChange={(e) => setPartUnit(Number(e.target.value) || 0)} />
                </div>
              </div>
